...
export const PlaylistCard = ({ name }: PlaylistCardProps) => {
  return (
    <div className="h-14 flex items-center lg:justify-center lg:flex-col lg:h-40 lg:w-36 select-none bg-warmGray-800 cursor-pointer rounded-sm text-white whitespace-nowrap">
